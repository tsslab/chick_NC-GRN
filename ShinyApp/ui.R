                        ...
                        tabPanel("Data", value=1, 
                                 ...
                                 conditionalPanel(condition="input.main_selection==3", 
                                                  ...
                                                  selectizeInput('Gene_Name_reg', 
                                                                 label = "",
                                                                 choices = NULL),
                                                  h3("Associated putative regulatory elements identified in Clusters-3-4-1"),
                                                  tableOutput('table_enh_clust'),
                                                  h3("Transcription factor binding motifs found in Cluster 3 and 1 elements"),
                                 ...
                                 conditionalPanel(condition="input.main_selection==4", 
                                                  ...
                                                  h4("Cluster 1"),  # only the header has been renamed from cluster 9 to 1, no need to change the variables
